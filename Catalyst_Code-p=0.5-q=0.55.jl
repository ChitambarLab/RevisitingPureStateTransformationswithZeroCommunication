...
ctr = 0
step_size = 0.005
for r1 in [0:step_size:0.18;]
    for r2 in [r1:step_size:0.2;]
        for r3 in [r2:step_size:0.2;]
            for r4 in [r3:step_size:0.22;]
                for r5 in [r4:step_size:0.24;]
                    for r6 in [r5:step_size:0.26;]
                        for r7 in [r6:step_size:0.3;]
...
ctr = 0
step_size = 0.005
for r1 in [0:step_size:0.16;]
    for r2 in [r1:step_size:0.16;]
        for r3 in [r2:step_size:0.16;]
            for r4 in [r3:step_size:0.17;]
                for r5 in [r4:step_size:0.19;]
                    for r6 in [r5:step_size:0.2;]
                        for r7 in [r6:step_size:0.21;]
                            for r8 in [r7:step_size:0.24;]
