            ...
            for r4 in [r3:step_size:0.4;]
                for r5 in [r4:step_size:0.5;]
                    for r6 in [r5:step_size:0.5;]
                        r = [r1,r2,r3,r4,r5,r6]
                        if r == [0,0.055,0.095,0.155,0.26,0.435]
                            print("here")
                        end
                        if ctr % 10^8 == 0
                            println("Now on ", r)
...
ctr = 0
step_size = 0.005
for r1 in [0.0:step_size:0.11;]
    for r2 in [r1:step_size:0.11;]
        for r3 in [r2:step_size:0.16;]
            for r4 in [r3:step_size:0.17;]
                for r5 in [r4:step_size:0.24;]
                    for r6 in [r5:step_size:0.25;]
                        for r7 in [r6:step_size:0.37;]
...
ctr = 0
step_size = 0.005
for r1 in [0:step_size:0.09;]
    for r2 in [r1:step_size:0.09;]
        for r3 in [r2:step_size:0.12;]
            for r4 in [r3:step_size:0.16;]
                for r5 in [r4:step_size:0.17;]
                    for r6 in [r5:step_size:0.23;]
                        for r7 in [r6:step_size:0.24;]
                            for r8 in [r7:step_size:0.36;]
