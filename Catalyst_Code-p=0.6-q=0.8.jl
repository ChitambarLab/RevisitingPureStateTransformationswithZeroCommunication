...
ctr = 0
step_size = 0.005
for r1 in [0.0:step_size:0.09;]
    for r2 in [r1:step_size:0.09;]
        for r3 in [r2:step_size:0.12;]
            for r4 in [r3:step_size:0.14;]
                for r5 in [r4:step_size:0.21;]
                    for r6 in [r5:step_size:0.26;]
                        for r7 in [r6:step_size:0.49;]
...
ctr = 0
step_size = 0.005
for r1 in [0:step_size:0.07;]
    for r2 in [r1:step_size:0.07;]
        for r3 in [r2:step_size:0.09;]
            for r4 in [r3:step_size:0.12;]
                for r5 in [r4:step_size:0.14;]
                    for r6 in [r5:step_size:0.2;]
                        for r7 in [r6:step_size:0.26;]
                            for r8 in [r7:step_size:0.48;]
